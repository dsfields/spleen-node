...
const msg = {
  ...
  argPrioritiesTarget:
    'Argument "priorities" object entries must contain a target of type string',
  argPrioritiesTargetStrEmpty:
    'Argument "priorities" objects\' target key cannot be an empty string',
  argPrioritiesLabel:
    'Argument "priorities" object entry label keys must be of type string',
};
